...
\texttt{drivetrain} are statistically indistinguishable from each other at
$\sim$0.29--0.30 held-out nMSE (their $\pm1\sigma$ bands overlap
substantially), roughly 6--8$\times$ higher than the other three families
at $\sim$0.035--0.047, which all transfer \emph{better} than
in-distribution when held out. \texttt{drivetrain}'s difficulty here is
